...
connection = sqlite3.connect('recipedatabase.db')
with open('databaschema.sql') as f:
    connection.executescript(f.read())

cur = connection.cursor()

cur.execute("INSERT INTO recipes (rimage,rname, rdescription,rcategory,ringredients,rprocedure) VALUES (?, ?, ?, ?, ?, ?)",
...
cur.execute("INSERT INTO loggedUsers (useremail, userpassword) VALUES (?, ?)",
            ('ogolasospeter62@gmail.com', 'admin')
            )
